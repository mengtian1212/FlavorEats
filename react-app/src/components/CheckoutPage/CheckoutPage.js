            ...
            <div className="checkout-main-info">
              ...
              <div className="checkout-delivery-box2">
                ...
                <p className="tip-desc">
                  ...
                  {isDeliveryT ? "your courier" : "restaurant"}. Tips are based
                  on your order subtotal of $
              ...
              <div className="checkout-delivery-box1">
                ...
                {isDeliveryT && (
                  <p className="total-desc">
                    ...
                    they'll leave your order at the door. By placing your order,
                    you agree to take full responsibility for it once it's
                    delivered. Orders containing alcohol or other restricted
                    items may not be eligible for leave at door and will be
                    returned to the store if you are not available.
                  </p>
                )}
              </div>
              <div className="check-spacer16"></div>
