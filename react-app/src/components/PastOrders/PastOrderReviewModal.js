import "../PlaceOrderPage/LeaveReviewModal.css";
...
function PastOrderReviewModal({ pastOrderId, restaurantId, resName }) {
  ...
  const orderItems = useMemo(() => {
    const orderItemsDict = orderJustPlaced?.order_items;
    return orderItemsDict ? Object.values(orderItemsDict) : [];
  }, [orderJustPlaced]);
...
export default PastOrderReviewModal;
